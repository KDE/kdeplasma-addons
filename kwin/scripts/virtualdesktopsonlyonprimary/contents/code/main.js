...
print("virtual desktops on only primary script starting...");
...
function processWindow(window) {
    ...
    let onCurrentDesktop = desktops.includes(currentDesktop);
    let onAllDesktops = desktops.length === 0;
    let windowIsRelevant = onCurrentDesktop || onAllDesktops;
