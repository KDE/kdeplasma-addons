...
#ifndef EXTRALIFEPROVIDER_H
#define EXTRALIFEPROVIDER_H

#include "comicprovider.h"

/**
 * This class provides the comic strip image for http://www.myextralife.com.
 */
class ExtraLifeProvider : public ComicProvider
{
    Q_OBJECT

    public:
        /**
         * Creates a new extralife provider.
         *
         * @param parent The parent object.
         */
        ExtraLifeProvider( QObject *parent, const QVariantList& );
