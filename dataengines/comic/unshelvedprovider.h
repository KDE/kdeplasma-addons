...
#ifndef UNSHELVEDPROVIDER_H
#define UNSHELVEDPROVIDER_H

#include "comicprovider.h"

/**
 * This class provides the comic strip image for unshelved.com.
 */
class UnshelvedProvider : public ComicProvider
{
    Q_OBJECT

    public:
        /**
         * Creates a new unshelved provider.
         *
         * @param parent The parent object.
         */
        UnshelvedProvider( QObject *parent, const QVariantList &args );

        /**
         * Destroys the unshelved provider.
         */
        ~UnshelvedProvider();
