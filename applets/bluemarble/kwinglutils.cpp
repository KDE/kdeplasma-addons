...
bool GLShader::load(const QString& vertexsource, const QString& fragmentsource)
    ...
    if(!vertexsource.isEmpty())
        ...
        if(!compiled)
            ...
            kDebug(1212) << "Vertex shader compilation log:" << endl << log;
    ...
    if(!fragmentsource.isEmpty())
        ...
        if(!compiled)
            ...
            kDebug(1212) << "Fragment shader compilation log:" << endl << log;
        // Attach the shader to the program
    ...
    if(!linked)
        ...
        kDebug(1212) << "Shader linking log:" << endl << log;
    delete[] log;
...
bool GLShader::setUniform(const QString& name, float valuex, float valuey, float valuez)
    {
    int location = uniformLocation(name);
    if(location >= 0)
        {
