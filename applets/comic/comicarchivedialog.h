...
class ComicArchiveDialog : public KDialog
{
    ...
    public:
        ComicArchiveDialog( const QString &pluginName, const QString &comicName, const QString &identifierType, const QString &currentIdentifierSuffix, const QString &firstIdentifierSuffix, QWidget *parent = 0 );
