...
{
    public:
        ComicEntry( const QString &_identifier, const QString &_title, const QString &_comicAuthor, const QPixmap &_icon );
...
class PluginManager
{
    public:
        ...
        QString comicAuthor( const QString &identifier ) const;
