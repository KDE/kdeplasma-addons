...
ColumnLayout {
    ...
    readonly property int minimalSpacing: Kirigami.Units.largeSpacing

    readonly property int preferredGraphHeight: Kirigami.Units.gridUnit * 6

    readonly property int dateTimeSection: WeatherData.FutureHoursPoints.Timestamp

    readonly property int hoursPerPage: root.futureHoursPoints?.hoursPerDay ?? 0

    readonly property int currentIndex: hoursPerPage * currentPageIndex

    readonly property int horizontalLabelsCount: 5
    readonly property int verticalLabelsCount: 4
    ...
    ForecastNavigation {
        ...
        visible: root.futureHoursPoints?.totalDays > 1
