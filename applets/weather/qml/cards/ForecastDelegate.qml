...
Rectangle {
    ...
    color: showBackground ? Qt.tint(Kirigami.Theme.backgroundColor, Qt.alpha(Kirigami.Theme.textColor, 0.05)) : "transparent"
    radius: Kirigami.Units.cornerRadius

    implicitHeight: dayDelegate.implicitHeight + Kirigami.Units.largeSpacing * 2

    // equalize the vertical spacing and the horizontal spacing for the default System Tray popup size
    implicitWidth: Kirigami.Units.iconSizes.large + Kirigami.Units.mediumSpacing
