...
GridLayout {
    ...
    Item {
        ...
        PlasmaComponents.Label {
            ...
            visible: !!root.lastObservation?.windSpeed && !!root.metaData?.windSpeedUnit && root.lastObservation.windSpeed !== 0.0
            ...
            text: Util.valueToDisplayString(root.displayWindSpeedUnit, root.lastObservation.windSpeed, root.metaData.windSpeedUnit, 1)
            textFormat: Text.PlainText
        }
    }
