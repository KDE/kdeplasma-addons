...
IView::IView(const QRectF &rect, QGraphicsItem *parent, Qt::WindowFlags wFlags)
: QObject(), m_rect(rect), m_parent(parent), m_wFlags(wFlags)
{
}
...
QGraphicsWidget *IView::createView(const QString &title)
{
...
const QList<QGraphicsWidget *> IView::views() const
{
    return m_views;
}
